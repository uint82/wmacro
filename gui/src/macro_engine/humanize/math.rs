...
pub fn eval_bezier(t: f32, p0: (f32,f32), p1: (f32,f32), p2: (f32,f32), p3: (f32,f32)) -> (f32,f32) {
    let u = 1.0 - t;
...
pub fn build_arc_lut(p0: (f32,f32), p1: (f32,f32), p2: (f32,f32), p3: (f32,f32), curve: f32) -> Vec<(f32, f32)> {
