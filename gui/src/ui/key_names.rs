//! maps linux evdev scancodes to display names for hotkey configuration.

use wmacro_core_types::Hotkey;

pub const COMMON_KEYS: &[(u16, &str); 113] = &[
    // linux evdev scancodes for the keys users actually bind hotkeys to; a pragmatic subset, not the full kernel table.
    // TODO: consider loading names from /usr/share/X11/xkb at runtime for exotic layouts.
    (1, "Esc"),
    (59, "F1"),
    (60, "F2"),
    (61, "F3"),
